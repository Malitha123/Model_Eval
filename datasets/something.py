...
DATA_PATH = './data/smth-smth-v2/something-something-v2-videos_avi'
ANNO_PATH = './data/smth-smth-v2/something-something-v2-annotations/'
...
class SOMETHING(VideoDataset):
    def __init__(self, subset,
        ...
        print(" length of file and labels",len(filenames), len(labels))
